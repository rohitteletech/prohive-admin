...
import { getLeaveReportData, toLeaveCsv } from "@/lib/companyReportsLeaves";
  ...
  try {
    ...
    const result = await getLeaveReportData({
      ...
      input: {
        ...
        employeeQuery: body.employeeQuery,
    ...
    return NextResponse.json(
      { error: error instanceof Error ? error.message : "Unable to export leave CSV." },
      { status: 500 }
    );
  }
}
