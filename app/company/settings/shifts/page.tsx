    ...
    <div className="mx-auto max-w-7xl px-2 pb-5 pt-0 sm:px-3 lg:px-4 lg:pb-6 lg:pt-0">
      <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div className="bg-gradient-to-r from-sky-600 via-blue-600 to-indigo-600 px-6 py-5 text-white">
          ...
          <h1 className="mt-1 text-2xl font-semibold tracking-tight">Shift Control</h1>
          <p className="mt-2 text-sm text-sky-100">Define, rename, and maintain shift type and timing rules for your company.</p>
        </div>
      </section>
