...
type AttendanceStatus = "present" | "late" | "half_day" | "absent" | "off_day_worked" | "manual_review";
...
export default function Page() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-2 pb-5 pt-0 sm:px-3 lg:px-4 lg:pb-6 lg:pt-0">
      ...
      <section className="mt-4 grid w-full gap-3 sm:grid-cols-2 xl:grid-cols-7">
        ...
        <article className="rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
          ...
          <p className="mt-1 text-[24px] font-semibold tracking-tight text-violet-700">{stats.manualReview}</p>
        </article>
      </section>
      ...
      <section className="mt-5 w-full rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
        <div className="grid gap-3 lg:grid-cols-4">
          ...
          >
            ...
            <option value="off_day_worked">Off Day Worked</option>
